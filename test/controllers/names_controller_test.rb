...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { address: @name.address, birthdate: @name.birthdate, cnpj: @name.cnpj, cpf: @name.cpf, email: @name.email, phone: @name.phone } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { address: @name.address, birthdate: @name.birthdate, cnpj: @name.cnpj, cpf: @name.cpf, email: @name.email, phone: @name.phone } }
